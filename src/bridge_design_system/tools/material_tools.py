...
class BeamUtilization:
    ...
    def add_cut(self, element_id: str, length_mm: int, kerf_loss_mm: int = 3) -> bool:
        ...
        self.utilization_percent = ((self.original_length_mm - self.remaining_length_mm) / self.original_length_mm) * 100
...
class MaterialInventoryManager:
    ...
    def update_beams(self, beams: List[BeamUtilization]) -> bool:
        ...
        try:
            ...
            self.inventory_data["total_utilization_percent"] = total_utilization / len(beams) if beams else 0
    ...
    def get_status(self, detailed: bool = False) -> Dict[str, Any]:
        ...
        status = {
            ...
            "overall_utilization_percent": (total_used / total_original * 100) if total_original > 0 else 0,
...
class CuttingOptimizer:
    ...
    def first_fit_decreasing(self, required_lengths: List[int], beams: List[BeamUtilization]) -> Dict[str, Any]:
        """
    ...
    def validate_feasibility(self, required_lengths: List[int], beams: List[BeamUtilization]) -> Dict[str, Any]:
        """
    ...
    def _generate_optimization_suggestions(self, cutting_result: Dict[str, Any]) -> List[str]:
        ...
        if efficiency < 80:
            suggestions.append(f"Material efficiency is low ({efficiency:.1f}%) - consider design optimization")
...
def create_session_record(session_id: str, elements: List[Dict[str, Any]], cutting_plan: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "summary": {
            ...
            "efficiency_percent": cutting_plan.get("summary", {}).get("material_efficiency_percent", 0)
        }
    }
