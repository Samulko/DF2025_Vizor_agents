...
class TestSysLogicOptimizationWorkflow:
    ...
    def setup_method(self):
        ...
        self.expected_element_lengths = [400, 400, 800, 400, 400, 900, 400, 400, 850, 800, 400, 400, 840, 840]

    @patch('src.bridge_design_system.agents.syslogic_agent_smolagents.validate_material_feasibility')
    ...
    def test_workflow_follows_proper_sequence(self, mock_status, mock_track, mock_plan, mock_feasibility):
        ...
        mock_feasibility.return_value = {
            ...
            "analysis": {
                "total_length_required_mm": 8230,
                "total_length_available_mm": 9633
            },
            "alternatives": [
    ...
    def test_feasible_design_proceeds_to_tracking(self, mock_plan, mock_feasibility):
        ...
        smaller_scenario = {
            "detailed_elements": {
                "Small Component": {
                    "Elements": [
                        {"Length": 0.4}, {"Length": 0.4}, {"Length": 0.5}
                    ]
                }
            }
        }
    ...
    def test_optimization_fallback_on_infeasible_design(self, mock_plan, mock_feasibility):
        ...
        mock_feasibility.return_value = {
            "feasible": False,
            "analysis": {
                "total_length_required_mm": 10000,
                "total_length_available_mm": 5000
            },
            "alternatives": [
...
class TestWorkflowIntegration:
    ...
    def test_element_length_extraction(self):
        ...
        test_elements = {
            ...
            "Component 2": {
                "Elements": [
                    {"Length": 0.6}   # Should become 600mm
                ]
            }
        }
