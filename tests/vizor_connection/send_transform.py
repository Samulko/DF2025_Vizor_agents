...
TRANSFORM_T1_POSES = [
    ...
    {
        "position": {
            "x": -0.06644491851329803,
            "y": -0.08316001296043396,
            "z": 0.33045026659965515,
        },
        "orientation": {"x": -0.0, "y": 0.0, "z": -0.0, "w": -1.0},
    },
    {
        "position": {
            "x": -0.3439379036426544,
            "y": 0.06487333029508591,
            "z": -0.025135979056358337,
        },
        "orientation": {"x": -0.0, "y": 0.0, "z": -0.0, "w": -1.0},
    },
]
...
TRANSFORM_T2_POSES = [
    ...
    {
        "position": {
            "x": -0.2936401963233948,
            "y": -0.18176478147506714,
            "z": -0.044508472084999084,
        },
        "orientation": {"x": -0.0, "y": 0.0, "z": -0.0, "w": -1.0},
    },
    {
        "position": {
            "x": -0.30347174406051636,
            "y": -0.12241509556770325,
            "z": -0.15938685834407806,
        },
        "orientation": {"x": -0.0, "y": 0.0, "z": -0.0, "w": -1.0},
    },
]
...
def parse_arguments():
    ...
    parser.add_argument(
        "transform_type", type=str, choices=["t1", "t2"], help="Transform type (t1 or t2)"
    )
    parser.add_argument(
...
def send_transform(transform_type, host="localhost", port=9090):
    ...
    try:
        ...
        # Create publisher for the topic (original format)
        ...
        message = {"names": names, "poses": poses}
