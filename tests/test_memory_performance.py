            ...
            for scale in scales:
                ...
                if len(times) >= 2:
                    ...
                    if write_ratio > scale_ratio * 1.5:
                        print(f"⚠️  Write performance degrading: {write_ratio:.2f}x vs {scale_ratio:.1f}x scale")
                    if search_ratio > scale_ratio * 2:
                        print(f"⚠️  Search performance degrading: {search_ratio:.2f}x vs {scale_ratio:.1f}x scale")
        ...
        try:
            ...
            for batch in range(20):
                ...
                if batch % 5 == 4:
                    ...
                    print(f"After {operations} operations: {current_memory:.1f} MB (+{growth:.1f} MB)")
