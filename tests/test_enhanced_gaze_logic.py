...
class EnhancedGazeLogicTester:
    ...
    def test_spatial_command_with_gaze(self) -> bool:
        ...
        try:
            ...
            response = self.triage_system.handle_design_request(
                "rotate this element a bit", gaze_id="dynamic_007"
            )
            ...
            if response.success:
                ...
                has_spatial_context = any(
                    indicator in response_text for indicator in spatial_indicators
                )
    ...
    def test_abstract_command_with_gaze(self) -> bool:
        ...
        try:
            ...
            response = self.triage_system.handle_design_request(
                "what is the status of this material inventory?", gaze_id="dynamic_004"
            )
            ...
            if response.success:
                ...
                has_material_context = any(
                    indicator in response_text for indicator in material_indicators
                )
    ...
    def test_ambiguous_command_with_gaze(self) -> bool:
        ...
        try:
            ...
            response = self.triage_system.handle_design_request(
                "let's review this", gaze_id="dynamic_002"
            )
            ...
            if response.success:
                ...
                asks_clarification = any(
                    indicator in response_text for indicator in clarification_indicators
                )
    ...
    def test_approach_question_with_gaze(self) -> bool:
        ...
        try:
            ...
            response = self.triage_system.handle_design_request(
                "what do you think about this approach?", gaze_id="dynamic_001"
            )
            ...
            if response.success:
                ...
                handles_approach = any(
                    indicator in response_text for indicator in approach_indicators
                )
