...
class MockTriageTestConfig:
    ...
    def _create_mock_memory_tools(self):
        ...
        def track_geometry_result(geometry_result: str, task_description: str) -> str:
            ...
            import re
            component_ids = re.findall(r'[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}', geometry_result)
    ...
    def _extract_and_track_components_from_result(self, result: Any, task: str):
        ...
        component_ids = re.findall(r'[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}', result_str)
    ...
    def get_memory_state(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "geometry_memory_steps": len(self.geometry_agent.memory.steps) if self.geometry_agent else 0,
