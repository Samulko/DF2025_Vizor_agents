...
class MockGrasshopperState:
    ...
    def add_component(
        self, comp_type: str, x: float, y: float, script: str = None
    ) -> Dict[str, Any]:
    ...
    def edit_component(self, comp_id: str, new_script: str) -> Dict[str, Any]:
        ...
        if self.next_error:
            ...
            self.components[comp_id]["last_output"] = self._generate_realistic_output(
                geometry_type, comp_id
            )
    ...
    def find_components_by_type(self, geometry_type: str) -> List[Dict[str, Any]]:
        ...
        return [
            comp for comp in self.components.values() if comp.get("geometry_type") == geometry_type
        ]
    ...
    def get_most_recent_component(self, geometry_type: str = None) -> Optional[Dict[str, Any]]:
        ...
        if geometry_type:
            candidates = [comp for comp in candidates if comp.get("geometry_type") == geometry_type]
...
def create_mock_mcp_tools():
    ...
    def add_python3_script(
        ...
        component = grasshopper_state.add_component(
            comp_type="Python3Component", x=x, y=y, script=script
        )

        return {"success": True, "data": component, "error": component.get("error")}

    @tool
    def edit_python3_script(component_id: str, new_script: str) -> Dict[str, Any]:
        """
    ...
    def get_component_details(component_id: str) -> Dict[str, Any]:
        ...
        if component_id in grasshopper_state.components:
            return {"success": True, "data": grasshopper_state.components[component_id]}
        else:
    ...
    def run_python_script(component_id: str) -> Dict[str, Any]:
        ...
        if component.get("has_error"):
            return {"success": False, "error": component.get("error", "Script has errors")}

        # Simulate successful execution
        return {
            "success": True,
            "data": {"output": "Script executed successfully", "component_id": component_id},
        }
    ...
    def delete_component(component_id: str) -> Dict[str, Any]:
        ...
        if component_id in grasshopper_state.components:
            ...
            return {"success": True, "data": {"message": f"Component {component_id} deleted"}}
        else:
            return {"success": False, "error": f"Component {component_id} not found"}
